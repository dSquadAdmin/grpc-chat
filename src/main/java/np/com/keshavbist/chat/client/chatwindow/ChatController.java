package np.com.keshavbist.chat.client.chatwindow;

import np.com.keshavbist.chat.client.login.MainLauncher;
import np.com.keshavbist.chat.client.util.VoicePlayback;
import np.com.keshavbist.chat.client.util.VoiceRecorder;
import np.com.keshavbist.chat.client.util.VoiceUtil;
import np.com.keshavbist.chat.messages.Message;
import np.com.keshavbist.chat.messages.MessageType;
import np.com.keshavbist.chat.messages.Status;
import np.com.keshavbist.chat.messages.User;
import np.com.keshavbist.chat.messages.bubble.BubbleSpec;
import np.com.keshavbist.chat.messages.bubble.BubbledLabel;
import np.com.keshavbist.chat.traynotifications.animations.AnimationType;
import np.com.keshavbist.chat.traynotifications.notification.TrayNotification;
