package np.com.keshavbist.chat.client.login;

import np.com.keshavbist.chat.client.chatwindow.ChatController;
import np.com.keshavbist.chat.client.chatwindow.Listener;
import np.com.keshavbist.chat.client.util.ResizeHelper;
...
public class LoginController implements Initializable {
    ...
    public void showErrorDialog(String message) {
        Platform.runLater(()-> {
            ...
            alert.setContentText("The Could not connect to the Server,\nThe server is down or firewall is blocking");
            alert.showAndWait();
        });
